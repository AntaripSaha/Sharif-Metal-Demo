            ...
            <table id="print_code" style="width: 630px;">
                ...
                <tbody>
                    ...
                    <tr style="margin-top:5px;">
                        ...
                        <td style="text-align: center; width: 15px;">{{number_format($product->del_qnt * $product->products->price)}}
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align: right;" colspan="2"><span style="margin-right: 13%;">=<?php echo (number_format($sum_total)) ?>/=</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;" colspan="2"><span style="margin-right: 13%;">({{ number_format((int)$chalan->del_discount)}})</span></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 5px;"><b style="font-size: 16px;">Grand Total</b></td>
                        <td style="text-align: right;" colspan="2"><span style="margin-right: 13%;">={{number_format((int)$chalan->del_amount)}}/=</span></td>
                    </tr>
                </tfoot>
