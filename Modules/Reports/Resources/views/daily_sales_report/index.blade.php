            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card_buttons">
                        ...
                        <a href="{{ route('reports.print_daily_sales_report') }}" class="btn btn-sm btn-info float-right" id="all_report">Download PDF</a>
                    ...
                    <div id="report_view" class="table-responsive">
                        <table id="ledgersTable" class="table table-sm table-bordered table-striped" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $sell_request->challan_no }}</td>
                                    <td>{{ $sell_request->v_date }}</td>
                                    <td>{{ $sell_request->req_id }}</td>
                                    ...
                                    <td>
                                        ...
                                        @foreach($products as $key => $product)
                                            @php
                                                $single_sales_amount += ( $product->del_qnt * $product->products->price )
                                            @endphp
                                        @endforeach
                                        {{ $single_sales_amount }} 
                        ...
                        <span class="float-right" style="margin-right: 15px">{{ $sell_requests->links() }}</span>
                    </div>
                </div>
            </div>
        </div>
